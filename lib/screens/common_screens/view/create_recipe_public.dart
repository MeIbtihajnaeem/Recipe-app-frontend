...
import '../bloc/public_recipe_cubit.dart';

@RoutePage(name: 'CreateRecipePublicRoute')
...
class CreateRecipePageBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<PublicRecipeCubit, PublicRecipeState>(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    context.read<PublicRecipeCubit>().createRecipe(recipeDto).then((_)=>{
                  ...
                  child:
                      const Text("Save Public Recipe", style: TextStyle(fontSize: 18)),
                ),
              ),
            ],
          ),
